...
public class UserServiceTest {
	...
	@Test
	public void testFindUsersEmpty(){
		assertEquals(new ArrayList<>(), userService.findUsers());
	}

	@Test
	public void testFindUsers() throws DuplicateInstanceException {
	...
	public void testDeleteUser() throws DuplicateInstanceException, InstanceNotFoundException {
		...
		assertThrows(InstanceNotFoundException.class, () -> userService.loginFromId(user.getId()));
	}
