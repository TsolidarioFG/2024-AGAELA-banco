...
import es.udc.tfgproject.backend.model.exceptions.*;
...
import static es.udc.tfgproject.backend.rest.dtos.EntityUserConversor.toEntityUserDtos;
import static es.udc.tfgproject.backend.rest.dtos.UserConversor.*;
...
public class UserController {
    ...
    public List<UserDto> findUsers(){
        return toUserDtos(userService.findUsers());
    }

    @DeleteMapping("/{id}")
    public void deleteUser(@PathVariable Long id) throws InstanceNotFoundException {
